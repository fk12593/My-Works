...
function initEvents(){
	$("#search1").keyup(function(){
		var val = $(this).val();
		if(val == ""){
			$(this).css("background-image",'url("css/images/wuyong.jpg")');
		}else{
...
function initEvents2(){
	$("#xialawangye dt").mouseover(function(){
    	$("#xialawangye dd").style.display = "block";
	});
	$("#xialawangye dt").mouseout(function(){
    	$("#xialawangye dd").style.display = "none";
	});
}